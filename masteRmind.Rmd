...
5. What is the class of your object and how would you check it?

### Task 2

6. Write a function `gen_code(n, dict, sep = ', ')` that generates a secret code
of length `n` from a dictionary of colors `dict`.  *Hint: use `sample()` and `std_dict`.*

7. Write a function `request_input()` with no inputs that prints a string prompting
